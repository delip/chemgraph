...
def get_query(
    ...
    query_dict = {
        ...
        "gibbs_free_energy_method_temperature": f"You are given a chemical reaction: {reaction_equation}. Calculate the Gibbs free energy change for this reaction using {method} at {temperature}K.",
    }
